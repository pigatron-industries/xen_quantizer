...
#define CONTROL_MUTE 0x7B
#define CONTROL_RPN_PARAM_LSB 0x64
#define CONTROL_RPN_PARAM_MSB 0x65
#define CONTROL_RPN_VALUE_COARSE 0x06
#define CONTROL_RPN_VALUE_FINE 0x26

#define RPN_PARAM_PITCH_BEND_RANGE 0x00
