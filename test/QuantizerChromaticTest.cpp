...
void test_quantizeChromatic() {
    ...
    QuantizerChromaticTest::test_quantize(0.083, Note(0, 1,  1/12.0));
    QuantizerChromaticTest::test_quantize(0.25,  Note(0, 3,  3/12.0));
    QuantizerChromaticTest::test_quantize(0.375, Note(0, 4,  4/12.0));
    QuantizerChromaticTest::test_quantize(0.376, Note(0, 5,  5/12.0));
    QuantizerChromaticTest::test_quantize(0.916, Note(0, 11, 11/12.0));
    ...
    QuantizerChromaticTest::test_quantize(1.083, Note(1, 1,  1+1/12.0));
    ...
    QuantizerChromaticTest::test_quantize(-0.916, Note(-1,  1, -1+1/12.0));
    QuantizerChromaticTest::test_quantize(-1,     Note(-1,  0, -1));
    QuantizerChromaticTest::test_quantize(-2,     Note(-2,  0, -2));
    QuantizerChromaticTest::test_quantize(-5,    Note( -5,  0, -5));
}
